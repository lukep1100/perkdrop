...
PerkDrop brings local offers, events, food, drinks, experiences and family activities into one place. Search across Australia or choose Near me to explore current listings within 50 km.

Browse places with their offers together, check dates and conditions, and open the official source before you go. Save offers you want to revisit. Where a venue supports an in-app Drop, you can claim available places and keep the pass in My perks.
...
- Precise location: accessed only after the user selects Near me; used to filter listings within 50 km. Embedded website map may separately request location while open.
...
1. Assign an Expo EAS project ID and verify ownership of bundle ID `au.perkdrop.app` in Apple Developer and Play Console.
